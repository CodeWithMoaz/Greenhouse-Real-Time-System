...
import model.WaterLevelSensor;
import java.awt.Color;
import javax.swing.JLabel;

public class Water_GUI extends javax.swing.JFrame {
    private Controller controller = null;
    private javax.swing.Timer updateTimer;
    private boolean isSystemOn = false;
    
    public Water_GUI(Controller c) {
        try {
            if (c == null) {
            ...
            if (controller.getWaterLevelSensor() != null) {
                WaterLevelSensor sensor = controller.getWaterLevelSensor();
                min.setText(String.format("%.1f", sensor.getMinLevel()));
                max.setText(String.format("%.1f", sensor.getMaxLevel()));
                
                isSystemOn = sensor.isIsRunning();
                updateOnOffButtonState();
            }
            
            updateTimer = new javax.swing.Timer(1000, (e) -> updateWaterLabels());
            updateTimer.start();
            
            this.setVisible(false);
        } catch (Exception e) {
            System.err.println("Error initializing water GUI: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/water.jpg"))); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(on_off_button, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void on_off_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (controller != null && controller.getWaterLevelSensor() != null) {
            controller.getWaterLevelSensor().setIsRunning(isSystemOn);
        }
    ...
    private void updateWaterLabels() {
        try {
            if (controller != null && controller.getWaterLevelSensor() != null) {
                float currentWater = controller.getWaterLevelSensor().getCurrent();
                float minWater = controller.getWaterLevelSensor().getMinLevel();
                float maxWater = controller.getWaterLevelSensor().getMaxLevel();
                
                current.setText(String.format("%.1f", currentWater));
                ...
                if (currentWater > maxWater) {
                    ...
                    current.setForeground(new Color(51, 0, 0));
            ...
            System.err.println("Error updating water labels: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void updateWater(float water) {
        try {
            if (current != null) {
                current.setText(String.format("%.1f", water));
            ...
            System.err.println("Error in updateWater: " + e.getMessage());
            e.printStackTrace();
        }
    }
